...
import com.learnpr1.journalApp.filter.JwtFilter;
...
//        return http.authorizeHttpRequests(request -> request
//                        .requestMatchers("/public/**","/journal/**", "/user/**").permitAll()
////                        .requestMatchers("/journal/**", "/user/**").authenticated()
//                        .requestMatchers("/admin/**").hasRole("ADMIN")
//                        .anyRequest().authenticated())
//                .httpBasic(Customizer.withDefaults())
...
//                .build();
    ...
    // ✅ Define AuthenticationManager properly without .and()
    @Bean
...
//                "http://localhost:4200",
//                "http://192.168.1.XX:4200"  // Add your device's IP/port
//        ));
...
//                registry.addMapping("/**")
//                        .allowedOrigins("*") // or specific origins like "http://192.168.1.25:4200"
